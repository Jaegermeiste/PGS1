...
AplayerCharacter::AplayerCharacter()
{
	...
	//setting the skeletal mesh of the class to the playerSkeletalMesh
...
int AplayerCharacter::getLifeCount()
{
	return lifeTracker;
}

void AplayerCharacter::updateLifeCount(int lifeChange)
{
	lifeTracker = lifeTracker + lifeChange;
}
